...
class DequeTests(unittest.TestCase):
    ...
    def test_capacity(self):
        # Sneakily makes guesses about the variable names
        # to guess their capacity if they use an array list implementation
        deque = Deque()
        for i in range(0, 1001):
            deque.push_back(i)
        try:
            self.assertGreaterEqual(2000, deque.cap)
        except AttributeError:
            pass
        try:
            self.assertGreaterEqual(2000, deque.capacity)
        except AttributeError:
            pass
        ...
        while not deque.is_empty():
            deque.pop_back()
        try:
            self.assertGreaterEqual(20, deque.cap)
        except AttributeError:
            pass
        try:
            self.assertGreaterEqual(20, deque.capacity)
        except AttributeError:
            pass
